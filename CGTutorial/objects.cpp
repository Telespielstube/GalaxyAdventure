...
/*
GLuint VertexArrayIDCoordinateSystem = 0;

static void createCoordinateSystem()
{
	glGenVertexArrays(1, &VertexArrayIDCoordinateSystem);
	glBindVertexArray(VertexArrayIDCoordinateSystem);

	// Punkte fuer die Koordinatenachsen. 3 Achsen mit jeweils 2 Punkten.
	static const GLfloat g_vertex_buffer_data[] = {
...
void drawCoordinateSystemImpl()
{
	if (!VertexArrayIDCoordinateSystem)
	{
		createCoordinateSystem();
	}
	glBindVertexArray(VertexArrayIDCoordinateSystem);
	glDrawArrays(GL_LINES, 0, 6); // 3 Linien haben 6 Punkte
}
*/
