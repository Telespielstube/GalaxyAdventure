...
static void createWireCube(float x, float y, float z,float colX, float colY, float colZ)
{
	...
	GLfloat g_vertex_buffer_data[] = {
		x,y,z, x,y, colZ+z,
		x,y +colY,z, x, colY + y, colZ + z,
		x +colX, y, z,  colX + x, y, colZ + z,
		x +colX, y +colY, z,  x +colX, y +colY, colZ + z,
		x, y, z, x, colY + y, z,
		x, y, z +colZ, x, colY + y, colZ + z,
		x +colX, y, z,  colX + x, colY + y, z,
		x +colX, y, z +colZ,  colX + x, colY + y, colZ + z,
		x, y, z,  colX + x, y, z,
		x, y, colZ + z,  colX + x, y, colZ + z,
		x, y +colY, z,  colX + x, colY + y, z,
		x, colY + y, colZ + z,  colX + x, colY + y, colZ + z
	};
...
void drawWireCube(float x, float y, float z, float colX, float colY, float colZ)
{
	
	if (!VertexArrayIDWireCube)
	{
		createWireCube(x,y,z,colX,colY,colZ);
	}
