...
Gate::Gate(const char *filename, Renderer &renderer, GLuint gateTexture, GLuint TextureID) : RenderedObject(filename, renderer)
{
	...
	addColCicle(new ColCicle(Position(0, 0, 0), 4.25f, 4.68f));
	addColCicle(new ColCicle(Position(0, 0, 0), 4.25f, 0.68f));
	...
	addColBox(new ColBox( Position(- 5,  - 5,  - 3.2,0,0), 10, 10, 4));

	addColBox(new ColBox(Position(- x,  - y,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position(+ x - xCol,  - y,  - z), xCol, yCol, zCol));

	x = 4.2; y = 0.5; xCol = 0.6; yCol = 0.5;
	addColBox(new ColBox(Position(- x,  + y,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position(+ x - xCol,  + y,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position(- x,  - y - yCol,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position(+ x - xCol,  - y,  - z), xCol, yCol, zCol));
	...
	addColBox(new ColBox(Position(+ x - xCol,  + y,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position(- x,  - y - yCol,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position( y+ x - xCol,  - y,  - z), xCol, yCol, zCol));
	...
	addColBox(new ColBox(Position(- x,  - y - yCol,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position(+ x - xCol,  + y,  - z), xCol, yCol, zCol));
	addColBox(new ColBox(Position(+ x - xCol,  - y - yCol,  - z), xCol, yCol, zCol));
